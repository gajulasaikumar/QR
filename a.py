...
def encode_file_data(file_data, filename, file_type):
    """Encode file data as base64 for URL"""
...
def create_data_url(file_data, filename, file_type):
...
def get_current_url():
    ...
    return "http://localhost:8501"  # Change this to your deployed URL
...
def main():
    ...
    with tab1:
        ...
        if uploaded_file is not None:
            ...
            with col1:
                ...
                st.markdown(f'<div class="share-url">{share_url}</div>', unsafe_allow_html=True)
                
                # Copy URL button
                if st.button("📋 Copy URL to Clipboard"):
                    st.write("Copy this URL:", share_url)
            ...
            💡 **Important:** Make sure your Streamlit app is deployed and accessible online for QR codes to work for others.
            """)
    ...
    with tab3:
        ...
        **FliQR** is a simple and secure way to share files using QR codes. Perfect for:
        ...
        For QR codes to work for others, make sure to:
        1. Deploy your Streamlit app online (e.g., Streamlit Community Cloud)
        2. Update the `get_current_url()` function with your deployed app URL
        3. Share the QR codes only after deployment
